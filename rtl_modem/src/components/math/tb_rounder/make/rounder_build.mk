...
DEF_LIB = ${LIB_PATH}/work
	...
	vcom -64 -2008 -work rtl_modem ${DIR}/src/pkg_rtl_modem.vhdl
	vcom -64 -2008 -work rtl_modem ${DIR}/src/components/math/rounder.vhdl
	...
	-work ${DEF_LIB} hdl_classes/pkg_rounder.sv \
	-work ${DEF_LIB} tb_rounder.sv