...
DEF_LIB = ${LIB_PATH}/work
	...
	vcom -64 -2008 -work rtl_modem ${DIR}/src/components/math/complex_rotator.vhdl
	...
	-work ${DEF_LIB} ${UVM_PATH}/rtl_modem/src/components/math/tb_sin_cos_table/hdl_classes/pkg_sincos.sv \
	-work ${DEF_LIB} ${UVM_PATH}/rtl_modem/src/components/math/tb_complex_multiplier/hdl_classes/pkg_compmult.sv \
	-work ${DEF_LIB} hdl_classes/pkg_comprot.sv \
	-work ${DEF_LIB} tb_complex_rotator.sv